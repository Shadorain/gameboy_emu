...
void ui_init () {
    ...
    debugScreen = SDL_CreateRGBSurface(0, (16*8*scale)+(16*scale), (32*8*scale)+(64*scale),
        32, 0x00FF0000, 0x0000FF00, 0x000000FF, 0xFF000000);

    sdlDebugTexture = SDL_CreateTexture(sdlDebugRenderer, SDL_PIXELFORMAT_ABGR8888,
        SDL_TEXTUREACCESS_STREAMING, (16*8*scale)+(64*scale), (32*8*scale)+(64*scale));
